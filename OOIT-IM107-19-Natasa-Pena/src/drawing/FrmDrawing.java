...
public class FrmDrawing extends JFrame {
	...
	public FrmDrawing() {
		...
		pnlDrawing.setBounds(110, 11, 654, 414);
		pnlDrawing.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		contentPane.setLayout(null);
		
		contentPane.add(pnlDrawing, BorderLayout.CENTER);
		
		JToggleButton tglbtnPoint = new JToggleButton("Point");
		tglbtnPoint.setBounds(0, 94, 100, 23);
		...
		tglbtnLine.setBounds(0, 128, 100, 23);
		...
		tglbtnCircle.setBounds(0, 166, 100, 23);
		...
		tglbtnDonut.setBounds(0, 200, 100, 23);
		...
		tglbtnRectangle.setBounds(0, 239, 100, 23);
		...
		tglbtnSelect.setBounds(0, 277, 100, 23);
		...
		tglbtnModify.setBounds(0, 311, 100, 23);
		contentPane.add(tglbtnModify);
		tglbtnModify.setFont(new Font("Tahoma", Font.BOLD, 11));
		tglbtnModify.setForeground(new Color(0, 0, 0));
		tglbtnModify.setBackground(new Color(255, 255, 255));
		...
		tglbtnDelete.setBounds(0, 345, 100, 23);
		contentPane.add(tglbtnDelete);
		tglbtnDelete.setFont(new Font("Tahoma", Font.BOLD, 11));
		tglbtnDelete.setForeground(new Color(0, 0, 0));
		tglbtnDelete.setBackground(new Color(255, 255, 255));
